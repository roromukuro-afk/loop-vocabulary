...
files = [
    ("seed-toeic-b24.json",        "tmp_toeic_b24.sql"),
    ("seed-eiken1-b12.json",       "tmp_e1_b12.sql"),
    ("seed-eiken3-b16.json",       "tmp_e3_b16.sql"),
    ("seed-eiken45-b16.json",      "tmp_e45_b16.sql"),
    ("seed-basic-daily-b14.json",  "tmp_daily_b14.sql"),
    ("seed-eiken-pre2-b17.json",   "tmp_pre2_b17.sql"),
    ("seed-eiken45-b17.json",      "tmp_e45_b17.sql"),
]

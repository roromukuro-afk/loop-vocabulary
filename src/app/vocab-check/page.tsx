...
const FAQ_ITEMS = [
  ...
  {
    q: "レベルはどのように判定されますか？",
    a: "20問中の正答数をもとに、中学英語レベル(〜1,500語目安・0〜4問正解)、高校基礎レベル(〜3,000語目安・5〜8問正解、英検2級相当)、大学受験レベル(〜5,000語目安・9〜12問正解、英検準1級・TOEIC 700点台相当)、英検準1級レベル(〜8,000語目安・13〜16問正解、IELTS 6.0・TOEIC 800点台相当)、ネイティブ上級レベル(10,000語以上目安・17〜20問正解)の5段階で判定します。あわせて、得意/苦手なレベル帯もスコアの内訳として表示されます。",
  },
  {
  ...
  {
    q: "回答データはどのように扱われますか？",
    a: "診断は匿名で実行され、個々の回答内容を第三者に販売・提供することはありません。学習データの取り扱い全般については、プライバシーポリシーをご確認ください。",
  },
  {

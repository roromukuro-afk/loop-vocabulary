...
const STAGES = [
  {
    ...
    desc: "日常で使う基本動詞・名詞を身につける。英語ゼロから始めよう。",
  },
  {
  ...
  },
  {
    ...
    label: "上級",
    title: "英検1級 必須単語",
    subtitle: "最上級レベル 1,000語",
    emoji: "🏆",
    colorBar: "bg-red-400",
    colorBadge: "bg-red-100 text-red-700",
    colorBorder: "border-red-200",
    colorDot: "bg-red-400",
    desc: "英検1級・TOEFL・学術英語に挑む。難解な語彙・フレーズを制覇しよう。",
  },
];

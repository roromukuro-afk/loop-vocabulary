  ...
  return (
    <div className="min-h-dvh bg-[#f7f9fc] pb-16">
      <div className="max-w-2xl mx-auto px-4 pt-3">
        <Breadcrumb items={[{ label: "ホーム", href: "/" }, { label: "学習ガイド", href: "/guide" }, { label: "フラッシュカードと4択テストの違い" }]} />
      </div>
      ...
      <div className="max-w-2xl mx-auto px-4 -mt-4 space-y-5">
        ...
        <div className="bg-gradient-to-r from-navy-700 to-navy-900 rounded-2xl p-6 text-white text-center">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            ...
            <Link href="/tools/vocab-test-maker" data-tool="vocab_test_maker" data-placement="bottom_cta" className="px-5 py-2.5 rounded-xl border border-white/30 text-white font-bold text-sm hover:bg-white/10 transition-colors">4択のPDFテストを無料で作成</Link>
          </div>
        </div>

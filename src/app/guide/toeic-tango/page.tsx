...
const FAQ_ITEMS = [
  {
    ...
    a: "ETS（TOEICの実施団体）は「必要語彙数〇語」という公式の数値を公表していません。市販の単語帳では1,000〜2,500語程度を収録しているものが多く、これは各出版社が過去の出題傾向から独自に選定した目安です。冊数や語数そのものよりも、模試・問題演習で分からなかった語句を記録し、繰り返し復習して定着させる方が実践的です。",
  },
  {

      ...
      <div className="max-w-2xl mx-auto px-4 -mt-4 space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-navy-100 shadow-sm p-5">
          ...
          <p className="mt-3 text-sm text-navy-700 leading-relaxed">
            Loop Vocabularyでは、正解が連続するたびに復習間隔を <strong>1日後 → 3日後 → 7日後 → 14日後 → 30日後</strong> と広げていくSRSアルゴリズムを内蔵しており、「今日復習すべき単語」だけを自動で出題します。間違えた単語は翌日にもう一度出題され、間隔が最初からやり直されます。
          </p>
          <p className="mt-3 text-sm text-navy-700 leading-relaxed">
        ...
        <div className="bg-white rounded-2xl border border-navy-100 shadow-sm p-5">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-navy-600 mt-1 leading-relaxed">
                人は覚えた直後から急速に忘れていきます。復習のタイミングを自己流にすると、忘れてから復習する非効率な形になりがちです。SRSは「忘れそうな直前」を狙って再出題することで、少ない回数で長期記憶に移しやすくします。Loop Vocabularyでは、正解を連続するたびに間隔が1日→3日→7日→14日→30日と広がっていく仕組みです。
              </p>
            </div>
          </div>
        </div>

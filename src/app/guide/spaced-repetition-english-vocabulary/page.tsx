        ...
        <div className="bg-white rounded-2xl border border-navy-100 shadow-sm p-5">
          ...
          <div className="space-y-3">
            {[
              ...
              { icon: "2️⃣", title: "評価に応じて次の出題日を計算", desc: "「普通」と答えると、単語ごとに持つ「思い出しやすさ」の指標に直前の間隔を掛けて次の間隔を決めます。「簡単」ではこの指標がさらに強く効いて間隔がより伸び、指標自体も上がります。「難しい」では指標は下がり、その回の間隔は固定倍率に学習モード別の重みを掛けた抑えめな値になります(モードによっては前回とほぼ同じか、やや短くなることもあります)。「もう一度」を選ぶと指標に関わらず翌日に戻ります(間隔の上限は半年程度)。" },

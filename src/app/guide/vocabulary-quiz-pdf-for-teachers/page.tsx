      ...
      <div className="max-w-2xl mx-auto px-4 -mt-4 space-y-5">
        ...
        <div className="bg-gradient-to-r from-navy-700 to-navy-900 rounded-2xl p-6 text-white text-center">
          ...
          <div className="flex gap-3 justify-center flex-wrap">
            ...
            <Link href="/tools/vocab-test-maker" className="px-5 py-2.5 rounded-xl border border-white/30 text-white font-bold text-sm hover:bg-white/10 transition-colors">貼り付けた単語でテストを作成</Link>
          </div>
        </div>

...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "単語帳の詳細画面にある「CSV一括インポート」機能(プレミアム機能、月額¥480〜)で、ダウンロードしたCSVファイルをそのままアップロードできます。ヘッダー行(word,meaning)も含めて出力しているため、追加の編集は不要です。単語を1件ずつ手動で追加する機能は無料プランでもご利用いただけます。",
  },
  {

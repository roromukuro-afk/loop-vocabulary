...
export default async function SchoolTestMaterialsLandingPage() {
  ...
  return (
    <AppShell>
      ...
      <Breadcrumb items={[{ label: "ホーム", href: "/" }, { label: "教材・単語帳", href: "/materials" }, { label: "定期テスト対策" }]} className="mb-2" />
      ...
      <div className="mt-6">
        ...
        <div className="space-y-2">
          ...
          <Link href="/guide/flashcards-vs-multiple-choice" className="block bg-white rounded-xl border border-navy-100 p-3 hover:shadow-sm transition-shadow">
            <div className="text-[11px] text-sky-600 font-semibold mb-0.5">学習法</div>
            <div className="text-sm font-semibold text-navy-800">フラッシュカードと4択テストの違い【消去法で正解するリスク】</div>
          </Link>
        </div>
      </div>

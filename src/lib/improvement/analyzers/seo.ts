...
type RobotsRule = { type: "allow" | "disallow"; prefix: string };

function parseRobotsRules(robotsTxt: string): RobotsRule[] {
 ...
 */
function isBlockedByRobots(rules: RobotsRule[], path: string): boolean {
